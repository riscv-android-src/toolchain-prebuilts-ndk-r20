/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../../riscv-gnu-toolchain/riscv-gcc/gcc/config/riscv/riscv.md'.  */
...
extern int fp_less_or_equal_comparison (rtx, machine_mode);
...
{
  if (c >= CONSTRAINT_B && c <= CONSTRAINT_U)
    return;
