...
#define MASK_32BIT (1U << 6)
#define MASK_64BIT (1U << 7)
#define MASK_ATOMIC (1U << 8)
#define MASK_DOUBLE_FLOAT (1U << 9)
#define MASK_DSP (1U << 10)
#define MASK_HARD_FLOAT (1U << 11)
#define MASK_MUL (1U << 12)
#define MASK_RVC (1U << 13)
#define MASK_RVE (1U << 14)
...
#define TARGET_LIBCCRT ((target_flags & MASK_LIBCCRT) != 0)
#define TARGET_LIBCCRT_P(target_flags) (((target_flags) & MASK_LIBCCRT) != 0)
...
#define TARGET_32BIT ((target_flags & MASK_32BIT) != 0)
...
enum opt_code
{
  ...
  /* OPT_ftail_call_workaround = 1027, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1028,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1029, */             /* -ftarget-help */
  ...
  OPT_ftest_forall_temp = 1034,              /* -ftest-forall-temp */
  /* OPT_fthis_is_variable = 1035, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1036,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1037,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1038,                   /* -ftime-report */
  OPT_ftime_report_details = 1039,           /* -ftime-report-details */
  ...
  OPT_ftrampolines = 1045,                   /* -ftrampolines */
  OPT_ftrapping_math = 1046,                 /* -ftrapping-math */
  OPT_ftrapv = 1047,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1048,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1049,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1050,                      /* -ftree-ccp */
  OPT_ftree_ch = 1051,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1052, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1053,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1054,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1055, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1056,                   /* -ftree-cselim */
  OPT_ftree_dce = 1057,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1058,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1059,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1060,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1061,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1062, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1063,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1064,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1065, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1066,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1067,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1068, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1069,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1070,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1071,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1072,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1073,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1074,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1075,                      /* -ftree-pre */
  OPT_ftree_pta = 1076,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1077,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1078, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1079,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1080,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1081,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1082,                     /* -ftree-slsr */
  OPT_ftree_sra = 1083,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1084, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1085, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1086,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1087,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1088,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1089, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1090,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1091, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1092,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1093,         /* -funconstrained-commons */
  OPT_funderscoring = 1094,                  /* -funderscoring */
  OPT_funit_at_a_time = 1095,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1096,              /* -funroll-all-loops */
  OPT_funroll_loops = 1097,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1098, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1099,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1100,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1101,                 /* -funsigned-char */
  OPT_funswitch_loops = 1102,                /* -funswitch-loops */
  OPT_funwind_tables = 1103,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1104,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1105,     /* -fuse-cxa-get-exception-ptr */
  ...
  OPT_fwrapv_pointer = 1136,                 /* -fwrapv-pointer */
  /* OPT_fxref = 1137, */                    /* -fxref */
  /* OPT_fzee = 1138, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1139,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1140,                     /* -fzero-link */
  OPT_g = 1141,                              /* -g */
  OPT_gant = 1142,                           /* -gant */
  OPT_gas_loc_support = 1143,                /* -gas-loc-support */
  OPT_gas_locview_support = 1144,            /* -gas-locview-support */
  /* OPT_gcoff = 1145, */                    /* -gcoff */
  /* OPT_gcoff1 = 1146, */                   /* -gcoff1 */
  /* OPT_gcoff2 = 1147, */                   /* -gcoff2 */
  /* OPT_gcoff3 = 1148, */                   /* -gcoff3 */
  OPT_gcolumn_info = 1149,                   /* -gcolumn-info */
  OPT_gdwarf = 1150,                         /* -gdwarf */
  OPT_gdwarf_ = 1151,                        /* -gdwarf- */
  OPT_gen_decls = 1152,                      /* -gen-decls */
  OPT_ggdb = 1153,                           /* -ggdb */
  OPT_ggnu_pubnames = 1154,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1155,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1156, /* -ginternal-reset-location-views */
  OPT_gnat = 1157,                           /* -gnat */
  OPT_gnatO = 1158,                          /* -gnatO */
  OPT_gno_ = 1159,                           /* -gno- */
  OPT_gno_pubnames = 1160,                   /* -gno-pubnames */
  OPT_gpubnames = 1161,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1162,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1163,                   /* -gsplit-dwarf */
  OPT_gstabs = 1164,                         /* -gstabs */
  OPT_gstabs_ = 1165,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1166,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1167,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1168,                        /* -gtoggle */
  OPT_gvariable_location_views = 1169,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1170,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1171,                           /* -gvms */
  OPT_gxcoff = 1172,                         /* -gxcoff */
  OPT_gxcoff_ = 1173,                        /* -gxcoff+ */
  OPT_gz = 1174,                             /* -gz */
  OPT_gz_ = 1175,                            /* -gz= */
  OPT_h = 1176,                              /* -h */
  OPT_idirafter = 1177,                      /* -idirafter */
  OPT_imacros = 1178,                        /* -imacros */
  OPT_imultiarch = 1179,                     /* -imultiarch */
  OPT_imultilib = 1180,                      /* -imultilib */
  OPT_include = 1181,                        /* -include */
  OPT_iplugindir_ = 1182,                    /* -iplugindir= */
  OPT_iprefix = 1183,                        /* -iprefix */
  OPT_iquote = 1184,                         /* -iquote */
  OPT_isysroot = 1185,                       /* -isysroot */
  OPT_isystem = 1186,                        /* -isystem */
  OPT_iwithprefix = 1187,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1188,              /* -iwithprefixbefore */
  OPT_k8 = 1189,                             /* -k8 */
  OPT_l = 1190,                              /* -l */
  OPT_lang_asm = 1191,                       /* -lang-asm */
  OPT_m4k_opts = 1192,                       /* -m4k-opts */
  OPT_mabi_ = 1193,                          /* -mabi= */
  OPT_maddsl = 1194,                         /* -maddsl */
  OPT_maddsluw = 1195,                       /* -maddsluw */
  OPT_march_ = 1196,                         /* -march= */
  OPT_mbionic = 1197,                        /* -mbionic */
  OPT_mbit_translate = 1198,                 /* -mbit-translate */
  OPT_mbranch_cost_ = 1199,                  /* -mbranch-cost= */
  OPT_mcbranch32 = 1200,                     /* -mcbranch32 */
  OPT_mccrt = 1201,                          /* -mccrt */
  OPT_mcmodel_ = 1202,                       /* -mcmodel= */
  OPT_mcondmv = 1203,                        /* -mcondmv */
  OPT_mdelete_redundancy_sext = 1204,        /* -mdelete-redundancy-sext */
  OPT_mdelete_vsetvl = 1205,                 /* -mdelete-vsetvl */
  OPT_mdiv = 1206,                           /* -mdiv */
  OPT_mdse_losum = 1207,                     /* -mdse-losum */
  OPT_mexpand_split_imm = 1208,              /* -mexpand-split-imm */
  OPT_mexplicit_relocs = 1209,               /* -mexplicit-relocs */
  OPT_mext = 1210,                           /* -mext */
  OPT_mfclass = 1211,                        /* -mfclass */
  OPT_mfdiv = 1212,                          /* -mfdiv */
  OPT_mfldr = 1213,                          /* -mfldr */
  OPT_mfmvhw32 = 1214,                       /* -mfmvhw32 */
  OPT_mfp16 = 1215,                          /* -mfp16 */
  OPT_mglibc = 1216,                         /* -mglibc */
  OPT_minterrupt_consecutive_branch = 1217,  /* -minterrupt-consecutive-branch */
  OPT_minterrupt_consecutive_branch2 = 1218, /* -minterrupt-consecutive-branch2 */
  OPT_mipush = 1219,                         /* -mipush */
  OPT_miv_adjust_addr_cost = 1220,           /* -miv-adjust-addr-cost */
  OPT_mldd = 1221,                           /* -mldd */
  OPT_mldd_more = 1222,                      /* -mldd-more */
  OPT_mldi = 1223,                           /* -mldi */
  OPT_mldr = 1224,                           /* -mldr */
  OPT_mmula = 1225,                          /* -mmula */
  OPT_mmusl = 1226,                          /* -mmusl */
  OPT_mopt_lbu = 1227,                       /* -mopt-lbu */
  OPT_mplt = 1228,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1229,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1230,                         /* -mrelax */
  OPT_mrev = 1231,                           /* -mrev */
  OPT_mrevw = 1232,                          /* -mrevw */
  OPT_msave_restore = 1233,                  /* -msave-restore */
  OPT_msignedness_cmpiv = 1234,              /* -msignedness-cmpiv */
  OPT_msmall_data_limit_ = 1235,             /* -msmall-data-limit= */
  OPT_msrri = 1236,                          /* -msrri */
  OPT_msrriw = 1237,                         /* -msrriw */
  OPT_mstrict_align = 1238,                  /* -mstrict-align */
  OPT_mstrip_sextw = 1239,                   /* -mstrip-sextw */
  OPT_mthread_jumps1 = 1240,                 /* -mthread-jumps1 */
  OPT_mtst = 1241,                           /* -mtst */
  OPT_mtune_ = 1242,                         /* -mtune= */
  OPT_muclibc = 1243,                        /* -muclibc */
  OPT_mvlen_ = 1244,                         /* -mvlen= */
  OPT_mxor_combine = 1245,                   /* -mxor-combine */
  OPT_n = 1246,                              /* -n */
  OPT_no_canonical_prefixes = 1247,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1248,              /* -no-integrated-cpp */
  OPT_no_pie = 1249,                         /* -no-pie */
  OPT_nocpp = 1250,                          /* -nocpp */
  OPT_nodefaultlibs = 1251,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1252,                   /* -nostartfiles */
  OPT_nostdinc = 1253,                       /* -nostdinc */
  OPT_nostdinc__ = 1254,                     /* -nostdinc++ */
  OPT_nostdlib = 1255,                       /* -nostdlib */
  OPT_o = 1256,                              /* -o */
  OPT_p = 1257,                              /* -p */
  OPT_pass_exit_codes = 1258,                /* -pass-exit-codes */
  /* OPT_pedantic = 1259, */                 /* -pedantic */
  OPT_pedantic_errors = 1260,                /* -pedantic-errors */
  OPT_pg = 1261,                             /* -pg */
  OPT_pie = 1262,                            /* -pie */
  OPT_pipe = 1263,                           /* -pipe */
  OPT_posix = 1264,                          /* -posix */
  OPT_print_file_name_ = 1265,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1266,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1267,          /* -print-multi-directory */
  OPT_print_multi_lib = 1268,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1269,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1270,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1271,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1272,               /* -print-prog-name= */
  OPT_print_search_dirs = 1273,              /* -print-search-dirs */
  OPT_print_sysroot = 1274,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1275,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1276,                        /* -profile */
  OPT_pthread = 1277,                        /* -pthread */
  OPT_quiet = 1278,                          /* -quiet */
  OPT_r = 1279,                              /* -r */
  OPT_rdynamic = 1280,                       /* -rdynamic */
  OPT_remap = 1281,                          /* -remap */
  OPT_s = 1282,                              /* -s */
  OPT_save_temps = 1283,                     /* -save-temps */
  OPT_save_temps_ = 1284,                    /* -save-temps= */
  OPT_shared = 1285,                         /* -shared */
  OPT_shared_libgcc = 1286,                  /* -shared-libgcc */
  /* OPT_specs = 1287, */                    /* -specs */
  OPT_specs_ = 1288,                         /* -specs= */
  OPT_static = 1289,                         /* -static */
  OPT_static_libasan = 1290,                 /* -static-libasan */
  OPT_static_libgcc = 1291,                  /* -static-libgcc */
  OPT_static_libgfortran = 1292,             /* -static-libgfortran */
  OPT_static_libgo = 1293,                   /* -static-libgo */
  OPT_static_liblsan = 1294,                 /* -static-liblsan */
  OPT_static_libmpx = 1295,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1296,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1297,               /* -static-libstdc++ */
  OPT_static_libtsan = 1298,                 /* -static-libtsan */
  OPT_static_libubsan = 1299,                /* -static-libubsan */
  OPT_static_pie = 1300,                     /* -static-pie */
  /* OPT_std_c__03 = 1301, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1302, */                /* -std=c++0x */
  OPT_std_c__11 = 1303,                      /* -std=c++11 */
  OPT_std_c__14 = 1304,                      /* -std=c++14 */
  OPT_std_c__17 = 1305,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1306, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1307, */                /* -std=c++1z */
  OPT_std_c__2a = 1308,                      /* -std=c++2a */
  OPT_std_c__98 = 1309,                      /* -std=c++98 */
  OPT_std_c11 = 1310,                        /* -std=c11 */
  OPT_std_c17 = 1311,                        /* -std=c17 */
  /* OPT_std_c18 = 1312, */                  /* -std=c18 */
  /* OPT_std_c1x = 1313, */                  /* -std=c1x */
  /* OPT_std_c89 = 1314, */                  /* -std=c89 */
  OPT_std_c90 = 1315,                        /* -std=c90 */
  OPT_std_c99 = 1316,                        /* -std=c99 */
  /* OPT_std_c9x = 1317, */                  /* -std=c9x */
  OPT_std_f2003 = 1318,                      /* -std=f2003 */
  OPT_std_f2008 = 1319,                      /* -std=f2008 */
  OPT_std_f2008ts = 1320,                    /* -std=f2008ts */
  OPT_std_f2018 = 1321,                      /* -std=f2018 */
  OPT_std_f95 = 1322,                        /* -std=f95 */
  OPT_std_gnu = 1323,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1324, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1325, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1326,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1327,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1328,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1329, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1330, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1331,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1332,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1333,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1334,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1335, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1336, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1337, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1338,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1339,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1340, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1341, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1342,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1343, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1344, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1345, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1346, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1347, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1348,                     /* -std=legacy */
  OPT_symbolic = 1349,                       /* -symbolic */
  OPT_t = 1350,                              /* -t */
  OPT_time = 1351,                           /* -time */
  OPT_time_ = 1352,                          /* -time= */
  OPT_traditional = 1353,                    /* -traditional */
  OPT_traditional_cpp = 1354,                /* -traditional-cpp */
  OPT_trigraphs = 1355,                      /* -trigraphs */
  OPT_u = 1356,                              /* -u */
  OPT_undef = 1357,                          /* -undef */
  OPT_v = 1358,                              /* -v */
  OPT_version = 1359,                        /* -version */
  OPT_w = 1360,                              /* -w */
  OPT_wrapper = 1361,                        /* -wrapper */
  OPT_x = 1362,                              /* -x */
  OPT_z = 1363,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
